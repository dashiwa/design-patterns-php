...
class Context
{
    // @var Strategy The Context maintains a reference to one of
    // the Strategy objects. The Context does not know the
    // concrete class of a strategy. It should work with all
    // strategies via the Strategy interface.
    private $strategy;

    // Usually, the Context accepts a strategy through the
    // constructor, but also provides a setter to change it at
    // runtime.
    ...
    // Usually, the Context allows replacing a Strategy object
    // at runtime.
