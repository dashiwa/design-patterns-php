...
// The Creator class declares the factory method that is
// supposed to return an object of a Product class. The
// Creator's subclasses usually provide the implementation of
// this method.
...
class ConcreteCreator1 extends Creator
{
    ...
    // is actually returned from the method. This way the
    // Creator can stay independent of concrete product classes.
...
// albeit through its base interface. As long as the client
// keeps working with the creator via the base interface, you
// can pass it any creator's subclass.
