...
//
// Intent: Provide a way to traverse the elements of an
...
class AlphabeticalOrderIterator implements \Iterator
{
    ...
    // @var int Stores the current traversal position. An
    // iterator may have a lot of other fields for storing
    // iteration state, especially when it is supposed to work
    // with a particular kind of collection.
    private $position = 0;

    // @var bool This variable indicates the traversal
    // direction.
...
// retrieving fresh iterator instances, compatible with the
// collection class.
