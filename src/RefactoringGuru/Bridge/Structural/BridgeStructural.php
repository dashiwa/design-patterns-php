...
// The Implementation defines the interface for all
// implementation classes. It doesn't have to match the
...
// Each Concrete Implementation corresponds to a specific
// platform and implements the Implementation interface using
// that platform's API.
...
// object gets linked with a specific Implementation object, the
// client code should only depend on the Abstraction class. This
// way the client code can support any abstraction-
